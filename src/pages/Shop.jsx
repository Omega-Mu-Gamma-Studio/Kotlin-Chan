 ...
 *   - outfit, no art       → Kotlin-Chan's real "teaching" sprite with
...
const DownloadWallpaperCard = ({ item, level }) => {
  ...
  const handleDownload = () => {
    ...
    a.download = item.fileName || 'kotlinchan-wallpaper.png';
    a.click();
    setDownloaded(true);
  ...
  return (
    <div className="shop-page">
      ...
      <section className="shop-section">
        ...
        <p className="shop-section-note">
          Kotlin-Chan's signature look — always available, can't be removed.
        </p>
        <div className="shop-grid">
          <motion.div
      ...
      <section className="shop-section">
        ...
        <p className="shop-section-note">
          Unlock outfits as you level up — equip them to change Kotlin-Chan's look across all 75 lessons.
        </p>
        <div className="shop-grid">
