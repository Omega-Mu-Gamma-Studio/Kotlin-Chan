...
const useLessonStore = create((set, get) => ({
  ...
  kotlinchanExpression: 'idle', // 'idle' | 'happy' | 'sad' | 'thinking' | 'surprised' | 'domain'
  ...
  setExpression: (expression) => set({ kotlinchanExpression: expression }),
