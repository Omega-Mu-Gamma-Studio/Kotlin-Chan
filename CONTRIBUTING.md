# Contributing to Kotlin-Chan

Thanks for your interest! Kotlin-Chan is an open-source project from Omega Mu Gamma Studio. Here's how to contribute effectively.
  ...
  "phases": [
    {
      "phase": 1,
      "title": "See It Work",
      "dialogue": "Explanation from Kotlin-Chan.",
      "code": "// Working Kotlin code",
